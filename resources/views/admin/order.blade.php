                    ...
                    <div class="row page-titles mx-0">
                        <div class="col-sm-6 p-md-0">
                            <div class="welcome-text">
                                <h4 class="text-primary">New order</h4>
                            </div>
                        </div>
                                        ...
                                        <table id="example1" class="display nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$order->id}}</td>
                                                    <td>
                                                      @if($order->image != '' && file_exists(public_path().'/uploads/employees/'.$order->image))
                                                     <img src="{{ url('uploads/employees/'.$order->image) }}" alt="" width="120" height="120" class="rounded-circle">
                                                         @else
                                                    ...
                                                    <td class="text-start">
                                                   <a href="{{route('deliverd',$order->id)}}" class="btn btn-primary">Deliverd</a>
                                                      
                                                    </td>
                                                    <td>
                                                    <a href="{{route('cancel',$order->id)}}" class="btn btn-primary">Cancel Order</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
