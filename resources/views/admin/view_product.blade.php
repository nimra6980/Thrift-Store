                    ...
                    <div class="row page-titles mx-0">
                        ...
                        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('add_product')}}">New Product</a></li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-header fix-card">
                                    <div class="row">
                                        ...
                                        <div class="col-4 float-end">
                                            <a href="{{route('add_product')}}" class="btn btn-primary float-end">New
                                                Product</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table id="example1" class="display nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$product->id}}</td>
                                                    <td>
                                                      @if($product->image != '' && file_exists(public_path().'/uploads/employees/'.$product->image))
                                                     <img src="{{ url('uploads/employees/'.$product->image) }}" alt="" width="120" height="120" class="rounded-circle">
                                                         @else
                                                    ...
                                                    <td class="text-start">
                                                        ...
                                                        <a class='mr-4 delet'href="{{route ('delete_product',$product->id)}}"><span class='fas fa-trash-alt tbl-delet'></span></a>
                                                        <a data-bs-toggle='modal' data-bs-target='#modal-edit'
                                                            class='mr-4'  href="{{route ('edit_product',$product->id)}}">
                                                            <span class='fas fa-pencil-alt tbl-edit'></span>
                                                        </a>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel"><img class="rounded-circle" width="35"
                            src="{{asset('admin/assets/images/patients/user1.jpg')}}" alt=""> Tiger Nixon </h5>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="modal-title-edit-row">{{ $product->title }} </h5>
                                ...
                                @method('put')
                                    <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-input">
                                                        ...
                                                        <input type="file" id="file-ip-1" accept="image/*"
                                                            onchange="showPreview(event);"src="{{ url('uploads/employees/'.$product->image) }}" >
                                                        <div class="preview">
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <input type="number" class="form-control"  name="qunatity"value="{{ old('quantity',$product->quantity) }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-4">
