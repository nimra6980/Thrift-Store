                                        ...
                                        <table id="example1" class="display nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$cancel->id}}</td>
                                                    <td>
                                                      @if($cancel->image != '' && file_exists(public_path().'/uploads/employees/'.$cancel->image))
                                                     <img src="{{ url('uploads/employees/'.$cancel->image) }}" alt="" width="120" height="120" class="rounded-circle">
                                                         @else
                                                     <img src="{{ url('assets/images/no-image.png') }}" alt="" width="120" height="120" class="rounded-circle">
                                                    @endif
                                                     </td>
                                                    <td>{{$cancel->product_title}}</td>
                                                    ...
                                                    <td class="text-start">
                                                   <a href="{{route('delete_cancelorder',$cancel->id)}}" class="btn btn-primary">Delete</a>
